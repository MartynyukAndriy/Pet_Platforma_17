...
Revision ID: e56b97b0924d
Revises: 
Create Date: 2023-09-22 21:36:40.097671
...
def upgrade() -> None:
    ...
    # op.execute("CREATE TYPE role AS ENUM('client', 'master', 'admin', 'moderator', 'superadmin')")
    ...
    sa.Column('role', sa.Enum('client', 'master', 'admin', 'moderator', 'superadmin', name='role'), nullable=True, default='client'),
